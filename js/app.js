    ...
    fillRootScopeForHome: function($rootScope, $sce, tenant, $window, $location, $route, $http, $scope, $compile) {
        ...
        try {
            ...
            MyCampusApp.rootScope.$on("$routeChangeSuccess", function(event, next, current) {
                ...
                $(".footerGroupIcons div div").css('opacity', 0.7);
                ...
                try {
                    $scope.confirm = function(btn) {
                        if (btn == 1) {
                            ...
                            window.location.href = "index.html#app/SignIn279/SignIn279";
...
try {
            var gcmSenderID = "1012473507211"; // Comment this line once we have added upgraded our platform to send push.
